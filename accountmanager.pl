...
#	    print "UT: $u <> $t<br>\n";
	...
	foreach(getusers())
	{
	    print "<li>".$cgi->checkbox(-name=>"_c_ac_".$_."_pass", -style=>"border:1px solid #990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", -label=>"$_ : change password\n").$cgi->hidden(-name=>"_c_ac_".$_."_pass_data", -style=>"border:1px solid #990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", -value=>[$cgi->param("ac_".$_."_pass"), $cgi->param("ac_".$_."_rpass")])."\n"
		if($cgi->param("ac_".$_."_pass"));
	    print "<li>".$cgi->checkbox(-name=>"_c_ac_".$_."_authority", -style=>"border:1px solid #990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", -label=>"$_ : change authority\n").$cgi->hidden(-name=>"_c_ac_".$_."_authority_data", -value=>$cgi->param("ac_".$_."_authority"))."\n"
		if($cgi->param("ac_".$_."_authority") && $cgi->param("ac_".$_."_authority") ne uihash($_)->{'authority'} && $cgi->param("ac_".$_."_authority") < 6);
	    print "<li>".$cgi->checkbox(-name=>"_c_ac_".$_."_authority", -style=>"border:1px solid #990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", -label=>"$_ : delete user\n").$cgi->hidden(-name=>"_c_ac_".$_."_authority_data", -value=>$cgi->param("ac_".$_."_authority"))."\n"
		if($cgi->param("ac_".$_."_authority") == 6);
	    
	}
	print "</ul>\n";
	print "<hr color=#FFFFFF>\n";
	if($ENV{'REGEN'}) {
	    system("./regen.pl");
	} else {
	    $ENV{'REGEN'}="yes";
...
<tr><td align=left class=\"Ltext\">new password<br>".$cgi->password_field(-name=>"ac_".$_."_pass")."</td><td align=\"right\" class=\"Rtext\">
detailed Management for " .$cgi->submit(-name=>"manage", -value=>$_)."</td></tr>
<tr><td align=left class=Ltext>retype password<br>
".$cgi->password_field(-name=>"ac_".$_."_rpass")."</td>
<td align=\"right\" class=\"Rtext\">
user authority:<br>".$cgi->popup_menu("ac_".$_."_authority",
					 [ '1', '2', '3', '4', '5', '6' ],
...
print "<hr color=#FFFFFF>\n";
    print $cgi->submit(-name=>"global", -value=>"Enact changes", -style=>"border:1px solid #990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;")." &nbsp; ";
    print $cgi->reset(-style=>"border:1px solid #990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", 'Reset changes')."<br><br>\n";
