...
sub optionhtml
{
    ...
    $ot.="\n<br><br>\n";
    $ot.=$cgi->submit(-style=>"border:1px solid 990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", -name=>"submit", -label=>"Save Settings")."&nbsp"x5;
    $ot.=$cgi->reset(-style=>"border:1px solid 990000;background:FF0000;font-family:verdana; font-size:10px; color:FFFFFF;", -label=>"Reset Changes");
    $ot.="\n<br><br>\n";
